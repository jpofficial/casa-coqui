...
const strings = {
  es: {
    ...
    cleaningOverrideHeld_title: 'Limpieza con fecha manual',
    cleaningOverrideHeld_body: '{unit} — la reserva cambió ({oldDate} → {newDate}) pero la fecha de limpieza fue fijada manualmente',
    cleaningInProgressWarning_title: 'Limpieza en progreso — fechas cambiaron',
    cleaningInProgressWarning_body: '{unit} — la reserva cambió ({oldDate} → {newDate}) pero la limpieza ya está en progreso',

    // ── ICS Sync (staff-facing) ──
    syncNewBooking_title: 'Nueva reserva de Airbnb',
    syncNewBooking_body: '{unit} — {checkIn} a {checkOut}',
    syncDateChanged_title: 'Fechas actualizadas (Airbnb)',
    ...
    // ── Airbnb email enrichment (staff-facing) ──
    staffAirbnbEnriched_title: 'Email de Airbnb recibido',
    staffAirbnbEnriched_body: 'Detalles de reserva enriquecidos por email para {guestName}',
  ...
  en: {
    ...
    cleaningOverrideHeld_title: 'Manually Pinned Cleaning',
    cleaningOverrideHeld_body: '{unit} — booking changed ({oldDate} → {newDate}) but cleaning date was manually set',
    cleaningInProgressWarning_title: 'Cleaning In Progress — Dates Changed',
    cleaningInProgressWarning_body: '{unit} — booking changed ({oldDate} → {newDate}) but cleaning is already in progress',

    // ── ICS Sync (staff-facing) ──
    syncNewBooking_title: 'New Airbnb Booking',
    syncNewBooking_body: '{unit} — {checkIn} to {checkOut}',
    syncDateChanged_title: 'Dates Updated (Airbnb)',
    ...
    // ── Airbnb email enrichment (staff-facing) ──
    staffAirbnbEnriched_title: 'Airbnb email received',
    staffAirbnbEnriched_body: 'Booking details enriched from email for {guestName}',
