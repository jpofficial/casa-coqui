export const ROLES = {
  ...
  cleaner: {
    label: 'Cleaner',
    allowedRoutes: ['/admin/cleaning', '/admin/getting-started', '/admin/staff-notifications'],
    defaultRedirect: '/admin/cleaning',
  },
  maintenance: {
    label: 'Maintenance',
    allowedRoutes: ['/admin/assignments', '/admin/getting-started', '/admin/staff-notifications'],
