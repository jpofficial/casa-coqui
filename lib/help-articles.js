...
const GUEST_ARTICLES = [
  {
    ...
    body: [
      ...
      { type: 'step', number: 2, content: 'Enter your phone number and verify with the code sent to your phone.' },
      ...
      { type: 'trouble', title: 'Didn\'t receive the verification code?', content: 'Make sure you entered the correct phone number. Wait 30 seconds, then tap "Resend code." If it still doesn\'t arrive, try again.' },
    ],
  },
  {
    id: 'check-in',
  ...
  },
  {
    ...
    category: 'onboarding',
    body: [
      { type: 'text', content: 'As the primary guest, you can invite up to 9 travel companions to access the guest portal.' },
      ...
      { type: 'trouble', title: 'Group is full?', content: 'The maximum is 10 people total (you + 9 companions). Remove a pending invite to make room.' },
    ],
  },
  {
    id: 'portal-expired',
