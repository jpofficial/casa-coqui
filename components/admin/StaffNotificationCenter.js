      ...
      <div className="px-4 pt-5 pb-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <Link
            ...
            className="p-2 text-gray-400 hover:text-coqui-600 active:text-coqui-700 transition rounded-lg hover:bg-gray-50"
            aria-label={t(locale, 'staffNotifSettings_title')}
          >
