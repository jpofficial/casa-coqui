 ...
 *
 * Usage:
 *   node scripts/migrations/fix-airbnb-dates.js                 # dry-run (default)
 *   node scripts/migrations/fix-airbnb-dates.js --apply         # write changes
 *   node scripts/migrations/fix-airbnb-dates.js --feed unit-a   # restrict to one feed
 *
